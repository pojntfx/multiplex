...
func init() {
	var classInit gobject.ClassInitFunc = func(tc *gobject.TypeClass, u uintptr) {
		...
		typeClass.BindTemplateChildFull("play-button", false, 0)
		typeClass.BindTemplateChildFull("stop-button", false, 0)
		typeClass.BindTemplateChildFull("volume-scale", false, 0)
		typeClass.BindTemplateChildFull("volume-button", false, 0)
		typeClass.BindTemplateChildFull("audiovolume-button-mute-button", false, 0)
		typeClass.BindTemplateChildFull("subtitle-button", false, 0)
		typeClass.BindTemplateChildFull("audiotracks-button", false, 0)
		typeClass.BindTemplateChildFull("fullscreen-button", false, 0)
		...
		typeClass.BindTemplateChildFull("elapsed-track-label", false, 0)
		typeClass.BindTemplateChildFull("remaining-track-label", false, 0)
		typeClass.BindTemplateChildFull("seeker", false, 0)
		typeClass.BindTemplateChildFull("watching-with-title-label", false, 0)
		typeClass.BindTemplateChildFull("stream-code-input", false, 0)
		typeClass.BindTemplateChildFull("copy-stream-code-button", false, 0)
		...
		objClass.OverrideConstructed(func(o *gobject.Object) {
			...
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "toast-overlay").Cast(&overlay)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "button-headerbar-title").Cast(&buttonHeaderbarTitle)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "button-headerbar-subtitle").Cast(&buttonHeaderbarSubtitle)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "play-button").Cast(&playButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "stop-button").Cast(&stopButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "volume-scale").Cast(&volumeScale)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "volume-button").Cast(&volumeButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "audiovolume-button-mute-button").Cast(&volumeMuteButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "subtitle-button").Cast(&subtitleButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "audiotracks-button").Cast(&audiotracksButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "fullscreen-button").Cast(&fullscreenButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "media-info-button").Cast(&mediaInfoButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "headerbar-spinner").Cast(&headerbarSpinner)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "menu-button").Cast(&menuButton)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "elapsed-track-label").Cast(&elapsedTrackLabel)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "remaining-track-label").Cast(&remainingTrackLabel)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "seeker").Cast(&seeker)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "watching-with-title-label").Cast(&watchingWithTitleLabel)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "stream-code-input").Cast(&streamCodeInput)
			parent.Widget.GetTemplateChild(gTypeControlsWindow, "copy-stream-code-button").Cast(&copyStreamCodeButton)
